...
ZIMAGE_DIR="${HOME}/android/Despair/arch/arm/boot"
...
function make_kernel {
		...
		make $DEFCONFIG
		make $THREAD
		cp -vr $ZIMAGE_DIR/$KERNEL ~/android/Despair/lk.ramdisk
}
...
function make_boot {
		cp -vr $ZIMAGE_DIR/zImage-dtb ~/android/Despair/lk.ramdisk/zImage-dtb
